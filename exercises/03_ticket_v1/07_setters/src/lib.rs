...
impl Ticket {
    ...
    pub fn set_title(&mut self, newt:String) {
        Self::validate_title(&newt);
        self.title = newt;
    }
    ...
    pub fn set_description(&mut self, newd:String) {
        Self::validate_description(&newd);
        self.description = newd
    }
    ...
    pub fn set_status(&mut self, new_status: String) {
        ...
        self.status = new_status; // Corrected to update the status field
    }
}
